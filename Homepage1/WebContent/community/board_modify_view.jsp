...
<form action="./BoardModifyAction.bo2?num=<%=board.getBOARD_NUM()%>" method="post"  name="modifyform" enctype="multipart/form-data"> 
...
<tr>
  <th>제목</th>
  <td>
  <input style="width:100%;" id="wr_subject" name="BOARD_SUBJECT" itemname="제목" value="<%=board.getBOARD_SUBJECT()%>">
  </td>
</tr>
  ...
  <tr>
    <th>작성자</th>
    <td>
    <input  title="제목"  name="BOARD_NAME" type="text" placeholder="작성자" size="20" maxlength="10" value="<%=board.getBOARD_NAME()%>"/>
    <input title="제목"  name="BOARD_PASS"  type="password" placeholder="비밀번호"/>
    </td>
  </tr>
     
     <tr>  
     <td colspan=2><textarea name="BOARD_CONTENT" cols="150" rows="18"><%=board.getBOARD_CONTENT()%></textarea></td>
      </tr>
