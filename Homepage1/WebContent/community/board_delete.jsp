...
<form name="BOARD_PASS" method="post" action="BoardDeleteAction.bo2?num=<%=num%>">
   ...
   <div id="gu_pass01">
      <ul>
         ...
         <li class="passicon02">
            ...
            <p class="passinfo02"><input type="password" name="BOARD_PASS" maxlength="20" style="width:100px"> 
