...
<!-- 공지글 처리 시작 -->
		...
		<tr>
         <td class="no"><%=bl.getBOARD_NUM()%></td>          
         ...
         <td class="author"><%=bl.getBOARD_NAME() %></td>         
         <td class="regDate"><%=bl.getBOARD_DATE() %></td>         
         <td class="hitCount"><%=bl.getBOARD_READCOUNT() %></td>                        
         </tr>
...
<div class="btnRight"><a href="./BoardWrite.bo2"><img src="../Image/board_wirtebtn.gif" /></a></div>

<tr align=center height=20>
		<td colspan=7 style=font-family:Tahoma;font-size:10pt;>
			<%if(nowpage<=1){ %> [이전]&nbsp;
			<%}else{ %>
			<a href="./BoardList.bo2?page=<%=nowpage-1 %>">[이전]</a>&nbsp;
			<%} %>
