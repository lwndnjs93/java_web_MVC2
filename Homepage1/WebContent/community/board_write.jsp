...
<form action="./BoardAddAction.bo2" method="post"  name="boardform" enctype="multipart/form-data"> 
...
<table class="write" summary="오렌지 게스트하우스">
  ...
  <tr>
    <th>제목</th>
    <td><input style="width:100%;"  id="wr_subject" name="BOARD_SUBJECT" itemname="제목" required value=""></td>
  </tr>
 
  <tr>
    <th>작성자</th>
    <td><input  title="제목"  name="BOARD_NAME" type="text" placeholder="작성자" size="20" maxlength="10" value=""/>
    <input title="제목"  name="BOARD_PASS"  type="password" placeholder="비밀번호"/></td>
  </tr>
     
     <tr>  
     <td colspan=2><textarea name="BOARD_CONTENT" cols="150" rows="18"></textarea></td>
      </tr>
