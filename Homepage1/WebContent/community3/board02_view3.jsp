...
<%
	...
	BoardBean3 board2 = (BoardBean3)request.getAttribute("boarddata2");
%>
<%
	...
	<div class="boardContents">
		<div class="boardViewInfo">
			<span class="titleSubject">
					<%=board.getBOARD3_SUBJECT()%></span>
			<span class="titleEtc">

				<span class="sect">|</span>
				<span class="hitCount">조회&nbsp;<span class="num"><%=board.getBOARD3_READCOUNT()%></span></span>

				
				<span class="sect">|</span>
				<span class="regDate"><span class="num"><%=board.getBOARD3_DATE()%></span></span>
...
<!-- 파일 업로드시 해당 파일이 파일업로드(에디터x) 일경우 컨텐츠 영역에 없을때 출력 시작 -->
		...
		<%=board.getBOARD3_CONTENT() %>
		</span>
		</div>
<!-- 게시물 내용 출력 끝 -->
<img src="../boardupload/<%=board.getBOARD3_FILE() %>">
...
<!-- 버튼 출력 시작 -->
	    	<div class="btnRight">
	    	<a href="./BoardList3.bo3" id="btn_list">
	    	<img src="../Image/board_listbtn.gif">
	    	</a>

				<a href="BoardModify3.bo3?num=<%=board.getBOARD3_NUM() %>" id="btn_modify"><img src="../Image/board_modifybtn.gif"></a>

				<a href="BoardDelete3.bo3?num=<%=board.getBOARD3_NUM() %>" id="btn_delete"  onclick="return confirm('삭제하시겠습니까?')"><img src="../Image/board_delete.gif"></a>

				<a href="BoardWrite3.bo3?num=<%=board.getBOARD3_NUM() %>" id="btn_write"><img src="../Image/board_wirtebtn.gif"></a>
			</div>
		</div>
<!-- 버튼 출력 시작 -->
				...
				<div class="commentRow" id="row_num_1">
					<div class="commentTitle">
						<div class="commentInfo">
							<span class="bl"><%=board2.getBOARD3RE_NAME() %></span>

						</div>
						<div class="commentBtn">
						<%=board2.getBOARD3RE_DATE() %>
						</div>
					</div>
...
<!-- 덧글쓰기 시작 -->
			...
			<form name="add_comment" id="add_comment" method="post" action="BoardReplyAction3.bo3?num=<%=num%>">
				...
				<div class="commentAuthor" style="height:26px;">
					...
					<input type="text" name="BOARD3RE_NAME" class="gu_inp02" maxlength="30">
					</span>
				</div>
				
				<div class="cWrite">
					<div class="commentWContent">
						<textarea name="BOARD3RE_CONTENT" id="wcontent" class="wcontent" rows="3"></textarea>
					</div>
