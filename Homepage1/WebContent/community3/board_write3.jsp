...
<form action="./BoardAddAction3.bo3" method="post"  name="boardform" enctype="multipart/form-data"> 
...
<table class="write" summary="오렌지 게스트하우스">
  ...
  <tr>
    <th>제목</th>
    <td><input style="width:100%;"  id="wr_subject" name="BOARD3_SUBJECT" itemname="제목" required value=""></td>
  </tr>
 
  <tr>
    <th>작성자</th>
    <td><input  title="제목"  name="BOARD3_NAME" type="text" placeholder="작성자" size="20" maxlength="10" value=""/>
    <input title="제목"  name="BOARD3_PASS"  type="password" placeholder="비밀번호"/></td>
  </tr>
     
     <tr>  
     <td colspan=2><textarea name="BOARD3_CONTENT" cols="150" rows="18"></textarea></td>
      </tr>
     
    <tr>
    <th>첨부파일
   <span onclick="add_file();" style="cursor:pointer;" name="BOARD3_FILE" ><img src="../Image/btn_file_add.gif"></span> 
...
<div class="center btn_r">
       <input type=submit id="bn_submit" value ="글쓰기">&nbsp;
        <input type=submit href="./board023.jsp" class='btn_list' value ="목록">
</div>
</form>
