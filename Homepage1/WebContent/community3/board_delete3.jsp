...
<form name="BOARD3_PASS" method="post" action="BoardDeleteAction3.bo3?num=<%=num%>">
   ...
   <div id="gu_pass01">
      <ul>
         ...
         <li class="passicon02">
            ...
            <p class="passinfo02"><input type="password" name="BOARD3_PASS" maxlength="20" style="width:100px"> 
