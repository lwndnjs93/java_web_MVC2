...
<script type="text/javascript" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_topMenu_1_0/include/js/dgc_topMenu_1_0.js"></script>
...
<a href="/main" onfocus=this.blur(); target="_self"> 
<img src="../Image/79f4b5a7e3180e9ebfaa80df40913920.png" width="300" height="270" class="banner1_css" title="logo" alt="logo" >
</a>
</div>
<div id="dgc_textnavi" type="plugin" rel="px" relwidth="1180px" relheight="60px" class="dgc_textnavi1"><style type="text/css">
...
<div class="gu_left_wrap">
	...
	<ul class="gu_left_accordion" id="menuBase" name="menuBase">
				...
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/menu01/menu01_1" class="top-menu">예약안내</a>
				<ul class="left_con1_02">
									</ul>
			</li>
					<li class="left_2deth" id="40">
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/menu01/menu01_2" class="top-menu">실시간예약</a>
				<ul class="left_con1_02">
									</ul>
			</li>
			</ul>
...
<div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px">
...
<script type="text/javascript" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_pension_1_0/include/js/dgc_pension_1_0.js"></script>
<script type="text/javascript">
	...
	$(".onlyeng").keyup(function(){$(this).val($(this).val().replace(/[^\!-z]/g,""));});
		...
		$.post("/menu01/menu01_2/?method=calPrice","ajax=1&"+$("#regvForm").serialize(),function(response){
...
<input type="hidden" name="roomNum" id="roomNum" value="4">
<input type="hidden" name="regDateTime" id="regDateTime" value="1496156400">
<input type="hidden" name="totalPrice" id="totalPrice" value="">
<input type="hidden" name="reserve_pension" id="reserve_pension" value="317343">
<input type="hidden" name="R_ROOMNAME" id="R_ROOMNAME" value="다래">
...
<div id="dgcWrap">
	...
	<dl class="text_box">
		...
		<dd>
			등록된 내용이 없습니다.			<span class="red">			성수기 2017-06-04~2017-06-05 /
						금요일 2017-06-30~2017-06-30 /
						금요일 2017-06-23~2017-06-23 /
						금요일 2017-06-16~2017-06-16 /
						금요일 2017-06-09~2017-06-09 /
						금요일 2017-06-02~2017-06-02 /
						금요일 2017-05-26~2017-05-26 /
						금요일 2017-05-19~2017-05-19 /
						성수기 2017-10-01~2017-10-08 /
			</span><br />
			</p>
		</dd>
	</dl>
	...
	<div class="nav_on2">
		<ul class="nav_area2">
			<li class="tab_01">
				...
				<div class="information_01 text_box" id="infoTabSub_1" name="infoTabSub_1">등록된 내용이 없습니다.</div >
			</li>
			<li class="tab_01">
				<div id="infoTab_2" name="infoTab_2">이용안내</div>
				<div class="information_02 text_box" id="infoTabSub_2" name="infoTabSub_2">등록된 내용이 없습니다.</div>
			</li>
			<li class="tab_01">
				<div id="infoTab_3" name="infoTab_3">환불규정</div>
				<div class="information_03 text_box" id="infoTabSub_3" name="infoTabSub_3">등록된 내용이 없습니다.</div>
			</li>
		</ul>
	</div>
	...
	<table class="rooms">
		...
		<tbody>
		<tr>
			<td>다래<br /><span class="button small red" style="margin-top:5px;"><input type="button" value="객실요금" id="roomInfoButton" name="roomInfoButton"></span></td>
			<td>2</td>
			<td>				
			<select title="추가인원을 선택 하여 주세요" class="select_05" name="R_OVERGUEST" id="R_OVERGUEST">
			...
			<td>2017.05.31</td>
			<td>
				<select title="숙박기간을 선택하여 주세요" class="select_05" name="R_STAY" id="R_STAY">
	...
	<table class="room_01">
		...
		<tr>
			...
			<td class="pension_input"><input type="text" id="G_GUESTNAME" name="G_GUESTNAME" value="" /></td>
		...
		<tr>
			...
			<th>도착예정시간</th>
			<td><select title="펜션도착 예정시각을 선택하세요." class="select_05" name="G_ARRIVAL_TIME" id="G_ARRIVAL_TIME">
		...
		<tr>
			<th>기타 메모</th>
			<td colspan="3"><textarea name="G_MEMO" id="G_MEMO" class="textarea" rows="8" cols="90">※메일주소:	  ※숙박인원 남: ( )명, 여: ( )명, 미성년자: ( )명</textarea></td>
		</tr>
		...
		<!-- 도배코드 로그인시에는 숨김처리 
				...
				<td colspan = "3">
					<span class="cCodeImage"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/captcha/1495373195.47.jpg" width="80" height="20" style="border:0;" alt=" " align='absmiddle' /></span>
					<span class="cCodeInput"><input type="hidden" name="user_captcha_check" id="user_captcha_check" value=""><input type="hidden" name="user_captcha_val" id="user_captcha_val" value="IDXCRS"><input type="text" name="user_captcha" id="user_captcha" class="input160" title="자동글쓰기방지" size="16" value=""></span>
	...
	<ul class="btnReservations">
		...
		<li><span class="button black"><a href="/menu01/menu01_2/?method=sth&roomNum=4&regDate=1496156400&year=2017&month=05">취소</a></span></li>
	</ul>
</div>
	...
	<dl>
		...
		<dd>
			...
			<ul>
				...
				<li class="rooms_cost_li2">100,000 원</li>
			</ul>
			<ul>
