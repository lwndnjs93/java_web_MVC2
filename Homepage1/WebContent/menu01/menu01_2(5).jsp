...
<script type="text/javascript" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_topMenu_1_0/include/js/dgc_topMenu_1_0.js">
</script>
...
<input type="hidden" name="roomNum" id="roomNum" value="6">
<input type="hidden" name="regDateTime" id="regDateTime" value="1495551600">
<input type="hidden" name="totalPrice" id="totalPrice" value="">
<input type="hidden" name="reserve_pension" id="reserve_pension" value="317343">
<input type="hidden" name="R_ROOMNAME" id="R_ROOMNAME" value="머루">
...
<div id="dgcWrap">
	...
	<table class="room_01">
		...
		<tr>
			<th>기타 메모</th>
			<td colspan="3"><textarea name="memo" id="G_MEMO" class="textarea" rows="8" cols="90">※메일주소:	  ※숙박인원 남: ( )명, 여: ( )명, 미성년자: ( )명</textarea></td>
		</tr>
		...
		<!-- 도배코드 로그인시에는 숨김처리
				...
				<td colspan = "3">
					<span class="cCodeImage"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/captcha/1495371657.39.jpg" width="80" height="20" style="border:0;" alt=" " align='absmiddle' /></span>
					<span class="cCodeInput"><input type="hidden" name="user_captcha_check" id="user_captcha_check" value=""><input type="hidden" name="user_captcha_val" id="user_captcha_val" value="XDFHJH"><input type="text" name="user_captcha" id="user_captcha" class="input160" title="자동글쓰기방지" size="16" value=""></span>
	...
	<ul class="btnReservations">
		...
		<li><span class="button black"><a href="/menu01/menu01_2/?method=sth&roomNum=6&regDate=1495551600&year=2017&month=05">취소</a></span></li>
	</ul>
</div>
