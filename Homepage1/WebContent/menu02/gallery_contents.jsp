...
<div id="text_navi_warp_dgc_textnavi1" style="line-height:1.5;">
	<ul class="glovalnavi_tx_dgc_textnavi1">
			...
			<li class="menu1">
			<a href="gallery.jsp" class="alink1 active">갤러리</a>
...
<div class="gu_position01">
	<div class="gu_position_title01">포토갤러리</div>
	<div class="gu_position_title02">갤러리 > 포토갤러리 </div>
...
<div class="gu_left_wrap">
	...
	<ul class="gu_left_accordion" id="menuBase" name="menuBase">
				...
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/menu02/menu02_1" class="top-menu">포토갤러리</a>
...
$(document).ready(function () {
	...
	$("#menuBase").accordion(43, 2, imgPath);
});
	...
	<div class="boardContents">
		<div class="boardViewInfo">
			...
			<span class="titleEtc">
				...
				<span class="hitCount">조회&nbsp;<span class="num">76</span></span>

				
				<span class="sect">|</span>
				<span class="regDate"><span class="num">2016-11-30 18:27:12</span></span>
...
<p style="text-align: center;"><br></p><p style="text-align: center;"><img name='target_resize_image[]' onclick='image_window(this)' src="../Image/63a8330eea95ffc66e597120dd1139f4.jpg" class="txc-image" style="clear:none;float:none;" /></p><p style="text-align: center;"><br></p><p><br></p>			</span>
		</div>
<!-- 게시물 내용 출력 끝 -->
...
<!-- 첨부파일 정보 시작 -->
			<div class="boardFiles">
				<img src="../Image/icon_files.gif" align="absmiddle">&nbsp;
<a href="/menu02/menu02_1/?method=download&no=109&fno=77">					test01.jpg</a>			</div>
<!-- 첨부파일 정보 끝 -->
...
<!-- 버튼 출력 시작 -->
	    	<div class="btnRight"><a href="/menu02/menu02_1/?method=lists&page=1" id="btn_list"><img src="../Image/board_listbtn.gif"></a>
...
$(document).ready(function(){
	$("#search_btn").click(function(){
        ...
        if($("#q").val() == ''){
			...
			var act = '/menu02/menu02_1/?method=lists&page=1&q='+$("#q").val()+'&sfl='+sfl_val;
