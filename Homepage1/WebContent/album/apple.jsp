...
<div class="gu_position01">
	<div class="gu_position_title01">애플(2인)</div>
	<div class="gu_position_title02">객실둘러보기 > 객실둘러보기 > 애플(2인) </div>
...
$(document).ready(function () {
	...
	$("#menuBase").accordion(34, 3, imgPath);
});
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><p><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/76fd098ee15ab539563f4a69676cdfd7.jpg" class="txc-image" usemap="#Map" style="text-align: center; font-size: 10pt; clear: none; float: none;" /></p>
<map name="Map" id="Map">
...
<p style="text-align: center;"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/0039a4f76b31ececa47ba0fe0046b280.jpg" class="txc-image" style="clear:none;float:none;" /></p><script>
						$(document).ready(function(){
