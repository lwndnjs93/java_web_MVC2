			...
			<a href="pomegranate.jsp" class="alink1 active">객실둘러보기</a>
				...
				<ul>
									<li><h2><a href="/album/album01">객실둘러보기</a></h2></li>
											...
											<li><a href="grape.jsp" class="alink2">포도(기준2인, 최대4인)</a></li>
									...
									<li><h2><a href="pnorama.jsp">전경둘러보기</a></h2></li>
...
<div class="gu_position01">
	<div class="gu_position_title01">전경둘러보기</div>
	<div class="gu_position_title02">객실둘러보기 > 전경둘러보기 </div>
...
$(document).ready(function () {
	...
	$("#menuBase").accordion(39, 2, imgPath);
});
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><p><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/3ac2079a29ddd6f154677bce0aed51df.jpg" class="txc-image" style="text-align: center; font-size: 10pt; clear: none; float: none;" /></p><script>
						$(document).ready(function(){
