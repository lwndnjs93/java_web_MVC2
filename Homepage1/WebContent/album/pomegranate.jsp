...
</div><div id="banner" type="plugin" rel="px" relwidth="300px" relheight="270px" class="banner1"><a href="../main/main.jsp" onfocus=this.blur(); target="_self"> <img src="../Image/79f4b5a7e3180e9ebfaa80df40913920.png" width="300" height="270" class="banner1_css" title="logo" alt="logo" ></a></div><div id="dgc_textnavi" type="plugin" rel="px" relwidth="1180px" relheight="60px" class="dgc_textnavi1"><style type="text/css">
...
<div id="text_navi_warp_dgc_textnavi1" style="line-height:1.5;">
	<ul class="glovalnavi_tx_dgc_textnavi1">
			...
			<a href="../product/service.jsp" class="alink1 ">이용안내</a>
						<div class="submenu ">
				<ul>
									<li><h2><a href="service.jsp">이용안내</a></h2></li>
			...
			<li class="menu1">
			<a href="pomegranate.jsp" class="alink1 active">객실둘러보기</a>
						<div class="submenu active">
				<ul>
									<li><h2><a href="pomegranate.jsp">객실둘러보기</a></h2></li>
											<li><a href="pomegranate.jsp" class="alink2">석류(2인)</a></li>
											<li><a href="apple.jsp" class="alink2">애플(2인)</a></li>
											<li><a href="grape.jsp" class="alink2">포도(기준2인, 최대3인)</a></li>
											<li><a href="cherry.jsp" class="alink2">체리(기준2인, 최대4인)</a></li>
											<li><a href="actini.jsp" class="alink2">다래(기준2인, 최대4인)</a></li>
											<li><a href="meoru.jsp" class="alink2">머루(기준2인, 최대4인)</a></li>
								  
									<li><h2><a href="panorama.jsp">전경둘러보기</a></h2></li>
			...
			<li class="menu1">
			<a href="./BoardList1.bo1" class="alink1 ">커뮤니티</a>
						<div class="submenu ">
				<ul>
									<li><h2><a href="../community/board01.jsp">공지사항</a></h2></li>
								  
									<li><h2><a href="../community/board02.jsp">예약문의</a></h2></li>
								  
									<li><h2><a href="../community/board03.jsp">방문후기</a></h2></li>
...
<div class="gu_position01">
	<div class="gu_position_title01">석류(2인)</div>
	<div class="gu_position_title02">객실둘러보기 > 객실둘러보기 > 석류(2인) </div>
...
<div class="gu_left_wrap">
	<div class="gu_left_title01">객실둘러보기</div>
	<ul class="gu_left_accordion" id="menuBase" name="menuBase">
					<li class="left_2deth" id="7">
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/album/album01" class="top-menu">객실둘러보기</a>
				<ul class="left_con1_02">
						
												<li id="32"><a href="pomegranate.jsp">석류(2인)</a></li>
												<li id="34"><a href="apple.jsp">애플(2인)</a></li>
												<li id="35"><a href="grape.jsp">포도(기준2인, 최대4인)</a></li>
												<li id="36"><a href="cherry.jsp">체리(기준2인, 최대4인)</a></li>
												<li id="37"><a href="actini.jsp">다래(기준2인, 최대4인)</a></li>
												<li id="38"><a href="meoru.jsp">머루(기준2인, 최대4인)</a></li>
															</ul>
			</li>
					<li class="left_2deth" id="39">
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="panorama.jsp" class="top-menu">전경둘러보기</a>
				<ul class="left_con1_02">
									</ul>
			</li>
			</ul>
...
$(document).ready(function () {
	...
	$("#menuBase").accordion(32, 3, imgPath);
});
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><p><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/b10354febe9e92bfaf84ae5e2a04c8c9.jpg" class="txc-image" style="font-size: 13.3333px; text-align: center; clear: none; float: none;" usemap="#Map" /></p>
<map name="Map" id="Map">
  <area shape="rect" coords="30,27,166,83" href="pomegranate.jsp" target="_self" />
  <area shape="rect" coords="180,29,315,80" href="apple.jsp" target="_self" />
  <area shape="rect" coords="333,28,467,83" href="grape.jsp" target="_self" />
  <area shape="rect" coords="485,29,617,81" href="cherry.jsp" target="_self" />
  <area shape="rect" coords="636,29,771,83" href="actini.jsp" target="_self" />
  <area shape="rect" coords="787,28,921,81" href="meoru.jsp" target="_self" />
</map>
<p style="text-align: center;"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/73a5c6614c54c566ab2d358cd493a6a4.jpg" class="txc-image" style="clear:none;float:none;" /></p>
<p><br></p><script>
						$(document).ready(function(){
