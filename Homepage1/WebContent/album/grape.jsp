...
<div class="gu_position01">
	<div class="gu_position_title01">포도(기준2인, 최대3인)</div>
	<div class="gu_position_title02">객실둘러보기 > 객실둘러보기 > 포도(기준2인, 최대3인) </div>
...
$(document).ready(function () {
	...
	$("#menuBase").accordion(35, 3, imgPath);
});
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><p><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/8a39b6323a5fc71a4360395bddfd5ff3.jpg" class="txc-image" style="text-align: center; font-size: 10pt; clear: none; float: none;" usemap="#Map" /></p>
<map name="Map" id="Map">
...
<p style="text-align: center;"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/92255aa4933c9d076d07959ba8c31bc7.jpg" class="txc-image" style="clear:none;float:none;" /></p><script>
						$(document).ready(function(){
