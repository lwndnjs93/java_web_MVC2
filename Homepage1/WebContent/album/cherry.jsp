...
<ul class="chu_topMenu1_area">
	...
	<!-- 홈(회원제 비회원제 모두 노출) -->
			<li><a href="../main/main.jsp" class="engkor">
			<span>HOME</span>
			</a>
			</li>
...
<div id="text_navi_warp_dgc_textnavi1" style="line-height:1.5;">
	<ul class="glovalnavi_tx_dgc_textnavi1">
			...
			<li class="menu1">
			<a href="service.jsp" class="alink1 ">이용안내</a>
						<div class="submenu ">
				<ul>
...
<div class="gu_position01">
	<div class="gu_position_title01">체리(기준2인, 최대4인)</div>
	<div class="gu_position_title02">객실둘러보기 > 객실둘러보기 > 체리(기준2인, 최대4인) </div>
...
$(document).ready(function () {
	...
	$("#menuBase").accordion(36, 3, imgPath);
});
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><p><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/ad681caa04181afc8cc28c103f64220c.jpg" class="txc-image" style="text-align: center; font-size: 10pt; clear: none; float: none;" usemap="#Map" /></p>
<map name="Map" id="Map">
...
<p style="text-align: center;"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/data/admin/html_upload/images/b6a3ed157807cb49f8fbce6063bc94fc.jpg" class="txc-image" style="clear:none;float:none;" /></p><script>
						$(document).ready(function(){
