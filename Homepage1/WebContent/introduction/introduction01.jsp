...
</div><div id="banner" type="plugin" rel="px" relwidth="300px" relheight="270px" class="banner1">
<a href="../main/main.jsp" onfocus=this.blur(); target="_self"> <img src="../Image/79f4b5a7e3180e9ebfaa80df40913920.png" width="300" height="270" class="banner1_css" title="logo" alt="logo" ></a></div><div id="dgc_textnavi" type="plugin" rel="px" relwidth="1180px" relheight="60px" class="dgc_textnavi1"><style type="text/css">
...
<div id="text_navi_warp_dgc_textnavi1" style="line-height:1.5;">
	<ul class="glovalnavi_tx_dgc_textnavi1">
			<li class="menu1">
			<a href="introduction01.jsp" class="alink1 active">오렌지게스트하우스</a>
						<div class="submenu active">
				<ul>
									<li><h2><a href="introduction01.jsp">인사말</a></h2></li>
								  
									<li><h2><a href="map01.jsp">오시는길</a></h2></li>
...
<div class="gu_position01">
	...
	<div class="gu_position_title02">오렌지게스트하우스 > 인사말 </div>
...
<div class="gu_left_wrap">
	...
	<ul class="gu_left_accordion" id="menuBase" name="menuBase">
				...
				<img class="left_con1_01" src="../Image/plus.gif"><a href="introduction01.jsp" class="top-menu">인사말</a>
				<ul class="left_con1_02">
									</ul>
			</li>
					<li class="left_2deth" id="3">
				<img class="left_con1_01" src="../Image/plus.gif"><a href="map01.jsp" class="top-menu">오시는길</a>
				<ul class="left_con1_02">
									</ul>
			</li>
			</ul>
...
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><p><img src="../Image/9c6ef62f4d104052b93b93eabc48b5eb.jpg" class="txc-image" style="text-align: center; font-size: 10pt; clear: none; float: none;" /></p><script>
						$(document).ready(function(){
