...
<form action="./BoardModifyAction1.bo1?num=<%=board.getBOARD1_NUM()%>" method="post"  name="modifyform" enctype="multipart/form-data"> 
...
<tr>
  <th>제목</th>
  <td>
  <input style="width:100%;" id="wr_subject" name="BOARD1_SUBJECT" itemname="제목" value="<%=board.getBOARD1_SUBJECT()%>">
  </td>
</tr>
  ...
  <tr>
    <th>작성자</th>
    <td>
    <input  title="제목"  name="BOARD1_NAME" type="text" placeholder="작성자" size="20" maxlength="10" value="<%=board.getBOARD1_NAME()%>"/>
    <input title="제목"  name="BOARD1_PASS"  type="password" placeholder="비밀번호"/>
    </td>
  </tr>
     
     <tr>  
     <td colspan=2><textarea name="BOARD1_CONTENT" cols="150" rows="18"><%=board.getBOARD1_CONTENT()%></textarea></td>
      </tr>
