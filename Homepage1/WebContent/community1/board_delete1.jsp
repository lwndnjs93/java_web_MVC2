...
<%
   int num=Integer.parseInt(request.getParameter("num"));
	...
	System.out.println("여기는 딜리트1 입니다  "+id);
%>
...
<div class="gu_left_wrap">
   ...
   <ul class="gu_left_accordion" id="menuBase" name="menuBase">
            ...
            <img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/community/board01" class="top-menu">공지사항</a>
            <ul class="left_con1_02">
                           </ul>
         </li>
               <li class="left_2deth" id="13">
            <img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/community/board02" class="top-menu">예약문의</a>
            <ul class="left_con1_02">
                           </ul>
         </li>
               <li class="left_2deth" id="44">
            <img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="/community/board03" class="top-menu">방문후기</a>
            <ul class="left_con1_02">
                           </ul>
         </li>
         </ul>
...
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><style type="text/css">
...
<form name="BOARD1_PASS" method="post" action="BoardDeleteAction1.bo1?num=<%=num%>&id=<%=id%>">

   <div id="gu_pass01">
      <ul>
         <li class="passicon01"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/board/views/default/images/icon_password.gif"></li>
         <li class="passicon02">
            <p class="passinfo01"><img src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/board/views/default/images/text-password.gif"></p>
            <p class="passinfo02"><input type="password" name="BOARD1_PASS" maxlength="20" style="width:100px"> 
            <input type="image" name="btn_submit" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/board/views/default/images/btn_ok.gif" /></p>
         </li>
      </ul>
   </div>
</form>
