...
<div id="text_navi_warp_dgc_textnavi1" style="line-height:1.5;">
   ...
   </div><div id="ndcs_con_a" type="layout" rel="px" relwidth="1180px" relheight="50px"><div id="dgc_navigation_bar_1_0" type="plugin" rel="px" relwidth="1140px" relheight="50px" class="dgc_navigation_bar_1_01"><style type="text/css">
...
<form action="./BoardAddAction1.bo1?id=<%=id %>" method="post"  name="boardform" enctype="multipart/form-data"> 
...
<table class="write" summary="오렌지 게스트하우스">
  ...
  <tr>
    <th>제목</th>
    <td><input style="width:100%;"  id="wr_subject" name="BOARD1_SUBJECT" itemname="제목" required value=""></td>
  </tr>
 
  <tr>
    <th>작성자</th>
    <td><input  title="제목"  name="BOARD1_NAME" type="text" placeholder="작성자" size="20" maxlength="10" value=""/>
    <input title="제목"  name="BOARD1_PASS"  type="password" placeholder="비밀번호"/></td>
  </tr>
     
     <tr>  
     <td colspan=2><textarea name="BOARD1_CONTENT" cols="150" rows="18"></textarea></td>
      </tr>
     
    <tr>
    <th>첨부파일
   <span onclick="add_file();" style="cursor:pointer;" name="BOARD1_FILE" ><img src="../Image/btn_file_add.gif"></span> 
