	...
	<ul class="glovalnavi_tx_dgc_textnavi1">
			...
			<a href="./BoardList1.bo1" class="alink1 active">커뮤니티</a>
				...
				<ul>
									...
									<li><h2><a href="./BoardList3.bo1">방문후기</a></h2></li>
...
<div class="gu_left_wrap">
	...
	<ul class="gu_left_accordion" id="menuBase" name="menuBase">
				...
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif">
				
				<a href="./BoardList1.bo1" class="top-menu">공지사항</a>
				...
				<a href="./BoardList.bo2" class="top-menu">예약문의</a>
				...
				<a href="./BoardList3.bo3" class="top-menu">방문후기</a>
...
</script></div></div><div id="ndcs_container" type="layout" rel="px" relwidth="950px" relheight="550px"><div id="contents" type="plugin" rel="px" relwidth="950px" relheight="300px" class="contents"><link href="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/board/views/default/css/board_comm.css" rel="stylesheet" type="text/css" />
<style type="text/css">
    ...
    <div class="boardContents">
    	<div class="boardListInfo">
			...
			<div class="boardListCount">
				<img src="../Image/icon_plus.png">TOTAL&nbsp;<span class="num">${listcount}</span>
...
<!-- 공지글 처리 시작 -->
				...
				<th width="80px">글쓴이</th>				<th width="80px">등록일</th>				
				<th width="50px">조회</th>											
				</tr>
		
		<%
		for(int i=0;i<boardList.size();i++){
			BoardBean1 bl=(BoardBean1)boardList.get(i);
		%>
		
		<tr>
         <td class="no"><%=bl.getBOARD1_NUM()%></td>          
         <input type='hidden' name="comment_cnt[]" id="comment_cnt199" value="1"></td>
         <td class="subject"> 
         <a href="./BoardDetailAction1.bo1?num=<%=bl.getBOARD1_NUM()%>&id=<%=id %>">
         <%=bl.getBOARD1_SUBJECT()%>
         </a>
         
         </td>
         <td class="author"><%=bl.getBOARD1_NAME() %></td>         
         <td class="regDate"><%=bl.getBOARD1_DATE() %></td>         
         <td class="hitCount"><%=bl.getBOARD1_READCOUNT() %></td>                        
         </tr>
...
<div class="btnRight"><a href="./BoardWrite1.bo1?id=<%=id%>"><img src="../Image/board_wirtebtn.gif" /></a></div>
<%} %>
...
<tr align=center height=20>
		<td colspan=7 style=font-family:Tahoma;font-size:10pt;>
			<%if(nowpage<=1){ %> [이전]&nbsp;
			<%}else{ %>
			<a href="./BoardList1.bo1?page=<%=nowpage-1 %>">[이전]</a>&nbsp;
			<%} %>
			...
			<%for(int a=startpage;a<=endpage;a++){
				...
				[<%=a %>]
				<%}else{ %>
				<a href="./BoardList1.bo1?page=<%=a %>">[<%=a %>]</a>&nbsp;
				<%} %>
			<%} %>
			...
			[다음]
			<%}else{ %>
			<a href="./BoardList1.bo1?page=<%=nowpage+1 %>">[다음]</a>
			<%} %>
		</td>
	</tr>       
