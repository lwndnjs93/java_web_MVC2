...
<%
	BoardBean1 board = (BoardBean1)request.getAttribute("boarddata");
	BoardBean1 board2 = (BoardBean1)request.getAttribute("boarddata2");
%>
<%
   int num=Integer.parseInt(request.getParameter("num"));
	...
	System.out.println("여기는 뷰페이지 아이디는   "+id);
%>
...
<div class="gu_left_wrap">
	...
	<ul class="gu_left_accordion" id="menuBase" name="menuBase">
				...
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="./BoardList1.bo1" class="top-menu">공지사항</a>
				...
				<img class="left_con1_01" src="http://xn--o79a21trqia095bdya41eyucq8bc06bhtg.kr/plugins/dgc_leftmenu_1_0/views/default/images/plus.gif"><a href="./BoardList3.bo3" class="top-menu">방문후기</a>
				<ul class="left_con1_02">
									</ul>
			</li>
			</ul>
	...
	<div class="boardContents">
		<div class="boardViewInfo">
			<span class="titleSubject">
					<%=board.getBOARD1_SUBJECT()%></span>
			<span class="titleEtc">

				<span class="sect">|</span>
				<span class="hitCount">조회&nbsp;<span class="num"><%=board.getBOARD1_READCOUNT()%></span></span>

				
				<span class="sect">|</span>
				<span class="regDate"><span class="num"><%=board.getBOARD1_DATE()%></span></span>
...
<!-- 파일 업로드시 해당 파일이 파일업로드(에디터x) 일경우 컨텐츠 영역에 없을때 출력 시작 -->
		...
		<%=board.getBOARD1_CONTENT() %>
		</span>
		</div>
<!-- 게시물 내용 출력 끝 -->
<img src="../boardupload/<%=board.getBOARD1_FILE() %>">
...
<!-- 버튼 출력 시작 -->
	    	<div class="btnRight">
	    	<a href="./BoardList1.bo1" id="btn_list">
	    	<img src="../Image/board_listbtn.gif">
	    	</a>
			
			<%if(id!=null && id.equals("ADMIN")){ %>
				<a href="BoardModify1.bo1?num=<%=board.getBOARD1_NUM()%>&id=<%=id %>" id="btn_modify"><img src="../Image/board_modifybtn.gif"></a>

				<a href="BoardDelete1.bo1?num=<%=board.getBOARD1_NUM()%>&id=<%=id %>" id="btn_delete"  onclick="return confirm('삭제하시겠습니까?')"><img src="../Image/board_delete.gif"></a>

				<a href="BoardWrite1.bo1?num=<%=board.getBOARD1_NUM()%>&id=<%=id %>" id="btn_write"><img src="../Image/board_wirtebtn.gif"></a>
			<%} %>
				...
				<div class="commentRow" id="row_num_1">
					<div class="commentTitle">
						<div class="commentInfo">
							<span class="bl"><%=board2.getBOARD1RE_NAME() %></span>

						</div>
						<div class="commentBtn">
						<%=board2.getBOARD1RE_DATE() %>
						</div>
					</div>
...
<!-- 덧글쓰기 시작 -->
			...
			<form name="add_comment" id="add_comment" method="post" action="BoardReplyAction1.bo1?num=<%=num%>">
				...
				<div class="commentAuthor" style="height:26px;">
					...
					<input type="text" name="BOARD1RE_NAME" class="gu_inp02" maxlength="30">
					</span>
				</div>
				
				<div class="cWrite">
					<div class="commentWContent">
						<textarea name="BOARD1RE_CONTENT" id="wcontent" class="wcontent" rows="3"></textarea>
					</div>
